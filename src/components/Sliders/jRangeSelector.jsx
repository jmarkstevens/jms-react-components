...
class RangeSelector extends React.Component {
  ...
  componentWillReceiveProps = (newProps) => {
    const lowerReset = Boolean(newProps.lowerValue === this.props.defaultLowerValue && newProps.upperValue === this.props.defaultUpperValue && newProps.lowerValue !== this.props.lowerValue);
    const upperReset = Boolean(newProps.upperValue === this.props.defaultUpperValue && newProps.lowerValue === this.props.defaultLowerValue && newProps.upperValue !== this.props.upperValue);
    ...
    if (this.state.dragging) {
      if (this.state.trackClicked) {
        ...
        if (!this.state.updateOnDrag) {
          this.props[`on${this.state.dragging}DragStop`](this.state[`${this.state.dragging.toLowerCase()}Value`], this.props.itemName);
        }
    ...
    return (
      <div className="mx-rangeselector" style={[styles.component, this.props.style]}>
        <div
          ...
          tabIndex={0}
        >
          <div className="mx-rangeselector-track-holder" onMouseDown={this._handleTrackMouseDown} role="button" style={styles.trackHolder} tabIndex={0}>
          ...
          <div
            ...
            tabIndex={0}
          >
            <span className="mx-rangeselector-lower-toggle-label" style={styles.lowerToggleLabel}>
          ...
          <div
            ...
            tabIndex={0}
          >
            <span className="mx-rangeselector-upper-toggle-label" style={styles.upperToggleLabel}>
